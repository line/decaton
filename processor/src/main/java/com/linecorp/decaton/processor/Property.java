 ...
 * the runtime.
 *
 * To supply {@link Property<T>} instance dynamically, you must configure your own {@link PropertySupplier} and
 * use {@link PropertySupplier#getProperty(PropertyDefinition)} to obtain an instance of bounded to the backend.
 *
 * To supply {@link Property<T>} instance statically, accepting the value can't be changed unless you restart
...
public interface Property<T> {
    /**
     * Returns {@link PropertyDefinition<T>} which represents definition of this property instance.
     ...
     *
     * A {@link BiConsumer<T>} listener takes two arguments which are respectively, the old value and the new
     ...
     * the current value.
     *
     * If the underlying property is {@link StaticProperty<T>}, as the value is static and will never be
     * changed, the given listener will never be called again.
     *
     * If the underlying property is {@link DynamicProperty<T>} or anything other that supports updating value,
     * the given listener will gets called every time the value of this property gets updated.
     *
     * @param listener a {@link BiConsumer<T>} which takes updates on this property value.
     */
    void listen(BiConsumer<T, T> listener);

    /**
     * Creates a {@link Property<T>} which has static value.
     * @param definition a {@link PropertyDefinition<T>} to associate with crated {@link Property<T>}.
     * @param value value of the property.
     * @param <T> type of the property value.
     * @return a {@link Property<T>} which has fixed value.
     */
    ...
    /**
     * Creates a {@link Property<T>} which has static value initialized with
